    ...
    public class DCategoria
    {
        ...
        public string Actualizar(Categoria Obj)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@descripcion", SqlDbType.VarChar).Value = Obj.Descripcion;
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo actualizar al registro";
            }
            catch (Exception ex)
            {
                Rpta = ex.Message;
        ...
        public string Eliminar(int Id)
        {
            ...
            try
            {
                ...
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo eliminar al registro";
            }
            catch (Exception ex)
            {
                Rpta = ex.Message;
        ...
        public string Activar(int Id)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@idcategoria", SqlDbType.Int).Value = Id;
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo activar al registro";
            }
            catch (Exception ex)
            {
                Rpta = ex.Message;
        ...
        public string Desactivar(int Id)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@idcategoria", SqlDbType.Int).Value = Id;
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo desactivar al registro";
            }
            catch (Exception ex)
            {
                Rpta = ex.Message;
